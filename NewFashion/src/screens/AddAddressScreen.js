...
const AddAddressScreen = ({navigation, route}) => {
  ...
  const getData = () => {
    ...
    if (currentLevel === 'district')
      return groupByFirstLetter(selectedCity?.districts || []);
    if (currentLevel === 'ward')
      return groupByFirstLetter(selectedDistrict?.wards || []);
    return [];
  };
    ...
    switch (field) {
      case 'fullname':
        error = !value.trim()
          ...
          : value.trim().length < 2
          ? 'Please enter your full name with no less than 2 characters'
          : '';
      ...
      case 'phoneNumber':
        ...
        error = !value
          ? 'Vui lòng nhập số điện thoại để chúng tôi có thể gọi để giải quyết bất kỳ vấn đề giao hàng nào'
          : !phoneRegex.test(value)
          ? 'Vui lòng nhập số điện thoại hợp lệ gồm 9 chữ số hoặc 10 chữ số bắt đầu bằng 0'
          : '';
  ...
  return (
    <View style={st.container}>
      {/* Header */}
      <BaseHeader
        title="Thêm địa chỉ để đặt hàng"
        showLeftButton={true}
        onLeftButtonPress={() => {
          navigation.goBack();
        }}
      ...
      <View style={st.descriptionContainer}>
        ...
        />
        <Text style={{color: '#008D42', fontSize: 12, fontWeight: 'semibold'}}>
          Tất cả dữ liệu được mã hóa
        </Text>
      </View>
      ...
      <View style={st.shippingContainer}>
        <View style={st.shippingItem}>
          ...
          />
          <Text style={{fontSize: 12, fontWeight: 'bold', color: '#008D42'}}>
            Miễn phí vận chuyển
          </Text>
        </View>
        ...
        <View style={st.shippingItem}>
          ...
          />
          <Text style={{fontSize: 12, fontWeight: 'bold', color: '#008D42'}}>
            Trả lại nếu sản phẩm bị hư hỏng
          </Text>
        </View>
      </View>
      ...
      <View style={st.inputContainer}>
        {/* fullname */}
        <Text style={st.label}>
          Họ tên đầy đủ <Text style={{color: '#F91616'}}>*</Text> (Họ và tên)
        </Text>
        <TextField
          value={fullname}
        ...
        {/* phoneNumber */}
        <Text style={st.label}>
          Số điện thoại <Text style={{color: '#F91616'}}>*</Text>
        </Text>
        <TextField
          value={phoneNumber}
        ...
        {/* city */}
        <Text style={st.label}>
          Thành phố <Text style={{color: '#F91616'}}>*</Text>
        </Text>
        <TextField
        ...
        {/* district */}
        <Text style={st.label}>
          Quận / Huyện <Text style={{color: '#F91616'}}>*</Text>
        </Text>
        <TextField
          type={TextFieldType.DROPDOWN}
        ...
        {/* ward */}
        <Text style={st.label}>
          Phường / Xã <Text style={{color: '#F91616'}}>*</Text>
        </Text>
        <TextField
          type={TextFieldType.DROPDOWN}
        ...
        {/* street name */}
        <Text style={st.label}>
          Tên đường <Text style={{color: '#F91616'}}>*</Text>
        </Text>
        <TextField
          value={streetName}
          ...
          <Animated.View
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <Text
                  style={
                    currentLevel === 'city' ? st.currentLevel : st.defaultLevel
                  }>
            ...
            <View
              ...
              <Image
                source={require('../assets/icons/ic_searchAddress.png')}
                resizeMode="contain"
                style={{width: 16, height: 16}}
              />
              <TextInput
            ...
            <SectionList
              ...
              renderItem={({item}) => {
                const isSelected =
                  (currentLevel === 'city' && item === selectedCity) ||
          ...
          <View style={st.modalView}>
            ...
            <View
              ...
              <Text style={{fontSize: 12, fontWeight: 'bold'}}>
                {streetName}, {selectedWard?.name}, {selectedDistrict?.name},{' '}
                {selectedCity?.name}
              </Text>
            </View>
