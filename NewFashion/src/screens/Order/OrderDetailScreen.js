            ...
            dispatch(cancelOrder(order._id))
              ...
              .catch(error => {
                ...
                Alert.alert(
                  ...
                  'Đơn hàng của bạn chưa thể xử lý, vui lòng thử lại sau',
                );
              });
          },
        },
    ...
    <View style={{backgroundColor: '#fff', flex: 1}}>
      ...
      <FlatList
        ...
        keyExtractor={(item, index) =>
          `${item._id}${index} orderItem in orderScreen`
        }
        ListHeaderComponent={
          <View>
            <View
              ...
              <View
                ...
                <Image
                  source={require('../../assets/icons/ic_Adress.png')}
                  style={{width: 25, height: 25, marginEnd: 10}}
                  resizeMode="contain"
                />
                <View style={{flexDirection: 'column'}}>
                  <View
                    ...
                    <Text
                      style={{color: '#737373', fontSize: 14, marginLeft: 10}}>
                      +84 {order.shippingAddress.phoneNumber}
                    </Text>
                  </View>
                  <Text
                    style={{
        ...
        renderItem={({item}) => (
          <View style={{paddingHorizontal: 20, paddingVertical: 10}}>
            ...
            <View
              style={{height: 1, backgroundColor: '#73737360', marginTop: 10}}
            />
          </View>
        )}
        ListFooterComponent={
          <View style={{padding: 20, paddingBottom: 0}}>
            ...
            <View
              ...
              <Text
                style={{fontSize: 16, fontWeight: 'bold', color: '#737373'}}>
          ...
          <Animated.View
            ...
            <View>
              <FlatList
                ...
                keyExtractor={(item, index) =>
                  `${item._id}${index} history in orderDetail`
                }
                renderItem={({item}) => (
                  <View
                    style={{
                    ...
                    <View style={{flexDirection: 'column', paddingBottom: 10}}>
                      <Text
                        ...
                        {
                          orderStatus.find(status => status.id === item.status)
                            ?.name
                        }
                      </Text>
                      <Text style={{fontWeight: 'bold'}}>
                        Vào lúc: {formatDate(item.timestamp)}
                      </Text>
                    </View>
                    <Text style={{fontWeight: 'bold'}}>
                      {item.updatedBy.name}
