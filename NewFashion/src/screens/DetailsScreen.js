...
const DetailsScreen = ({navigation, route}) => {
  ...
  useEffect(() => {
    dispatch(fetchProductById(item._id))
      ...
      .catch(error => {
        ...
        Alert.alert(
          'Thông báo',
          'Có lỗi xảy ra khi tải đánh giá sản phẩm. Vui lòng thử lại sau.',
        );
      });
  }, []);
  ...
  useEffect(() => {
    ...
    const saveItemToLocal = async () => {
      try {
        ...
        const isItemExists = itemsArray.some(
        ...
        Alert.alert(
          'Thông báo',
          'Có lỗi xảy ra khi lưu sản phẩm vào lịch sử duyệt web.',
        );
      }
    };
  ...
  const onExpire = () => {
    ...
    // Hiển thị thông báo
    Alert.alert('Thông báo', 'Chương trình giảm giá đã kết thúc', [
      {
        text: 'OK',
        onPress: () => {
    ...
    <View style={st.container}>
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            source={require('../assets/icons/ic_getback.png')}
            style={{width: 35, height: 35}}
          />
        </TouchableOpacity>
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <TouchableOpacity
            onPress={handleSelectCartButton}
            style={{marginRight: 10}}>
            <Image
              source={require('../assets/buttons/bt_cart.png')}
              style={{width: 35, height: 35}}
            />
      ...
      <FlatList
        ...
        keyExtractor={(item, index) =>
          `${item._id}${index} product in product detail`
        }
        renderItem={({item}) => (
        ...
        ListHeaderComponent={
          <>
            ...
            <View
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Text
                  style={{fontSize: 14, fontWeight: 'medium', marginRight: 5}}>
                  {item.rating}
                </Text>
            ...
            <View style={{marginHorizontal: 20, marginTop: 10}}>
              ...
              <View style={{marginTop: 10}}>
                <FlatList
                  ...
                  horizontal
                  keyExtractor={(item, index) =>
                    `${item._id}${index} color in product detail`
                  }
                  renderItem={({item}) => (
                    <TouchableOpacity
                      ...
                      {item.stock < 10 && (
                        <Image
                          source={require('../assets/icons/ic_almostSoldOut.png')}
                          style={{
                            width: 14,
                            height: 14,
                            position: 'absolute',
            ...
            <View style={{marginHorizontal: 20, marginTop: 10}}>
              ...
              <View style={{marginTop: 10}}>
                <FlatList
                  ...
                  horizontal
                  keyExtractor={(item, index) =>
                    `${item._id}${index} size in productDetail`
                  }
                  renderItem={({item}) => (
                    <TouchableOpacity
                      ...
                      style={{
                        marginRight: 10,
                        borderWidth: item == selectedSize ? 1.5 : 1,
                        borderColor: item == selectedSize ? '#000' : '#BBBBBB',
                        borderRadius: 12.5,
                      }}>
                      <Text
                        style={{
            ...
            <View style={{marginHorizontal: 20, marginTop: 20}}>
              <View
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <Image
                    source={require('../assets/icons/ic_ship.png')}
              ...
              <View
                ...
                <Image
                  source={require('../assets/icons/ic_j&t.png')}
            ...
            <View style={{marginHorizontal: 20, marginTop: 10}}>
              <View
                ...
                <TouchableOpacity>
                  <Text
                    style={{fontWeight: 'medium', fontSize: 12, color: '#000'}}>
                    Xem tất cả
                  </Text>
                </TouchableOpacity>
              </View>
              ...
              <FlatList
                data={reviews}
                keyExtractor={(item, index) =>
                  `${item._id}${index} review in product detail`
                }
                renderItem={({item}) => (
                  <View
                    style={{
            ...
            <View
              style={{width: '100%', height: 6, backgroundColor: '#EEEEEE'}}
            />
