            ...
            {item.replies && item.replies.length > 0 && (
              <FlatList
                ...
                keyExtractor={(item, index) =>
                  `${item._id} ${index} replies in comments`
                }
                    ...
                    <View style={styles.commentContent}>
                      <View
                        ...
                        <Text style={styles.time}>
                          {getTimeAgoText(reply.createdAt)}
                        </Text>
                      </View>
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={{flex: 1}}>
          <FlatList
            ...
            keyExtractor={(item, index) =>
              `${item._id}${index} comment in commentScreen`
            }
        ...
        {replyInfor && (
          <View
            ...
            <Text style={styles.replyText}>
              Đang trả lời{' '}
              <Text style={{fontWeight: 'bold'}}>{replyInfor.name}</Text>
            </Text>
            <TouchableOpacity
